    ...
    <a-layout style="min-height: 100vh">
        <a-layout>
                    ...
                    <a-col>
                        <a-row type="flex" align="right" :gutter="20">
                            ...
                            <a-col v-if="role==0">
                                ...
                                <a-modal v-model:visible="addCourseVisible" @ok="joinRoom()">
                                    <a-typography-title :level="5">
                                        课堂暗号
                                    </a-typography-title>
            ...
            <a-layout-content style="padding:0 25px">
                <a-empty description="暂无已加入的课堂" style="top:50%;left:50%;position: absolute;" v-if="rooms.length==0" />
                                    ...
                                    <a-col v-if="role==0">
                                        <a-dropdown>
                                            ...
                                            <template #overlay>
                                                <a-menu>
                                                    <a-menu-item>
                                                        <div class="my-hover" @click="joinHistoryRoom()">加入历史课堂</div>
                                                    </a-menu-item>
                                                    <a-menu-item>
