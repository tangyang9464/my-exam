    ...
    <a-layout style="min-height: 100vh">
        <a-layout>
            ...
            <a-layout-content style="padding:0 25px">
                <a-empty description="暂无试卷" style="top:50%;left:50%;position: absolute;" v-if="roomAllData.papers==undefined" />
                        ...
                        <a-card hoverable style="width: 300px;">
                            ...
                            <div class="my-text-center" v-if="role==0">
                                ...
                                <router-link :to="'/paperDetail/' + paper.id">
                                    ...
                                    <a-button type="success" v-if="paper.finishStatus==2">查看试卷</a-button>
                                </router-link>
                            </div>
                        </a-card>
                    </a-col>
