                        ...
                        <a-card hoverable style="width: 300px;margin-bottom: 50px;">
                            ...
                            <a-row type="flex" :gutter="[0,10]" align="middle" class="my-bottom">
                                ...
                                <a-col :span="12">
                                    ...
                                    <a-typography-text type="secondary">{{record.TrueNumber}}</a-typography-text>
                                </a-col>
                                ...
                                <a-col :span="24">
                                    ...
                                    <a-typography-text type="secondary">{{record.submitTime}}</a-typography-text>
                                </a-col>

                                <a-col :span="24">
                                    <a-typography-text type="secondary">截止时间：</a-typography-text>
                                    <a-typography-text type="secondary">{{record.deadline}}</a-typography-text>
                                </a-col>
